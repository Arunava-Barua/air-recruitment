...
const AIR_CONFIG = {
  apiKey: "N4LwS4znY4DD1BFKrShI43YICgLnAZoeKLIeuLf4",
  ...
  const handleAIRCredentialIssuance = async (
    ...
    try {
      ...
      const credentialSubject = {
        ...
        isCryptoUser: 2, // Assuming candidate is a crypto user since they have a wallet
      };
          ...
          <CardContent className="p-6">
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
              <div className="text-xs text-gray-700 space-y-1">
                ...
                <p>
                  <strong>API Key:</strong> {AIR_CONFIG.apiKey.substring(0, 8)}
